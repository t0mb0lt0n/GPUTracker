...
extension String {
    ...
    static let onlineLegendDescription: String = "All online services are available"
    static let parLegendDescription: String = "All online services are available"
    static let partiallyOnlineLegendDescription: String = "Some online services are disconected"
    static let offlineLegendDescription: String = "All services are disconected"
}
